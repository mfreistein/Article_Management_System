...
#import View
from src.Conception.View import View
...
class TestView(TestCase):
    ...
    def test_general_editors_dashboard(self):
        ...
        with patch('sys.stdout', new=StringIO()) as fake_out:
            View.general_editors_dashboard()
    ...
    def test_article_suggestions_page(self):
        ...
        with patch('sys.stdout', new=StringIO()) as fake_out:
            View.article_suggestions_page(3)
            self.assertEqual(fake_out.getvalue(), expected_output)
    ...
    def test_new_article_suggestions_page(self):
        ...
        with patch('sys.stdout', new=StringIO()) as fake_out:
            View.new_article_suggestions_page()
            self.assertEqual(fake_out.getvalue(), expected_output)
